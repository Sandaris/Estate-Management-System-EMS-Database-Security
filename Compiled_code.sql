/* ========================================================================
   ...
   Single-file build: the whole database in one script. Identical SQL to
   DDL.sql + DML.sql, which are the same build split in two - use whichever
   layout you prefer, but keep them in step if you edit one.

     PART A - structure: tables, roles, users, permissions, views,
              procedures, masking, keys, audit objects, triggers
     PART B - data and operations: seed load, encryption, hashing,
              backups, restore rehearsal, verification
...
/* ========================================================================
   PART A: STRUCTURE
   Creates every object. Loads no data.
   ======================================================================== */
...
-- >>> Seed data for all 10 tables (467 rows) - see PART B below.
...
-- >>> Role / view / procedure inventory queries - see PART B below.
...
-- >>> Encrypting the Clients PII columns - see PART B below.
...
-- >>> Encrypting LeaseAgreements.AgreementDocPath - see PART B below.
...
-- >>> Generating the per-user salts and SHA2_512 hashes - see PART B below.
...
-- >>> Key-material backup, database backups, restore rehearsal - see PART B below.
...
-- >>> Audit status verification queries - see PART B below.
...
-- >>> Trigger inventory verification query - see PART B below.
...
/* ========================================================================
   PART B: DATA AND OPERATIONS
   Seed load, encryption and hashing, backups and the restore rehearsal.
   The table triggers created in Part A are switched off for the load and
   back on afterwards - see Section 4.
   ======================================================================== */
